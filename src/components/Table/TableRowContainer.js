...
// Component
//-----------------------------------------------------------------------------
const TableRowContainer = ({ backgroundColor, children, isHeader, justifyContent }) => {
  return (
    <Container
...
const Container = styled.div`
  ...
  top: ${ props => props.isHeader ? '-3vh' : '0' };
  width: 100%;
  padding: 1.5vh 0;
  ...
  &:hover {
    border-right: ${ props => props.isHeader ? '3px solid ' + props.backgroundColor : '3px solid ' + colors.PRIMARY };
    background-color: ${ props => props.isHeader ? props.backgroundColor : colors.ACCENT };
  }
`
